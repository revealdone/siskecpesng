...
<template>
    ...
    <AppLayout>
        <div class="mx-auto max-w-xl space-y-4 rounded-xl bg-white p-4 shadow dark:bg-gray-800">
            <h2 class="text-xl font-semibold">Tambah Sertifikat Diklat</h2>

            <form @submit.prevent="submit" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium">Keterangan Diklat cth(Diklat IT)</label>
                ...
                <div>
                    <label class="block text-sm font-medium">Tanggal Diklat dilaksanakan / Tanggal Awal</label>
